          ...
          <div className="max-w-5xl mx-auto bg-primary p-12 md:p-20 relative overflow-hidden text-center">
            <div className="relative z-10">
              ...
              <div className="flex flex-col md:flex-row justify-center gap-6 items-center">
                <a className="bg-secondary text-on-secondary px-12 py-6 rounded-lg font-headline font-black text-lg tracking-tight hover:bg-on-secondary-container transition-all flex items-center gap-4" href="tel:+1800VIPORT">
